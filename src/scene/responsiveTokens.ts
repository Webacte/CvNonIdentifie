...
export function computeResponsiveTokens(metrics: ViewportMetricsInput): ResponsiveTokens {
    ...
    const cssVars: Record<string, string> = {
        ...
        '--rocket-width': 'min(22vw, 320px)',
        '--rocket-height': 'min(22vw, 320px)',
        '--rocket-left': '10vw',
        '--rocket-top': '-60vh',
        ...
        '--mask-chemine-clip-raw': 'polygon(65% 30%, 178% 0, 100% 100%, 0% 100%, 0% 45.5%)',
        '--exp-alien2-left-percent': '-2.6',
        '--exp-alien2-width-percent': '9.5',
        '--convoyeur-left-px': round(-w * 0.45, 0),
        '--convoyeur-bottom-px': round(h * 0.24, 0),
        '--convoyeur-w-px': round(w * 1.05, 0),
        '--convoyeur-h': '20.3',
        '--robot-above-y-percent': round(robotAboveYPercent, 1),
        '--robot-ground-y-percent': round(robotGroundYPercent, 1),
        '--robot-final-x-mult': '1',
        '--quest-titre-left': '2vw',
        '--quest-titre-top': '5vh',
        '--quest-titre-max-width': '50vw',
        '--quest-descrip-top': '16vh',
